      ...
      <div className="d-flex flex-grow-1">
        <nav className={`sidebar p-3${sidebarVisible ? '' : ' d-none'}`} id="sidebar" style={{ minWidth: '200px' }}>
          <ul className="nav flex-column">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/configuracoesL">Configurações</Link>
            </li>
            <li>
              <Link to="/login" className="btn btn-outline-light border border-light mt-3" onClick={handleLogout}>Logout</Link>
            </li>
          </ul>
        </nav>
                ...
                <div key={book.id} className="col-lg-3 col-md-4 col-sm-6">
                  <div className="card shadow-sm mb-4">
                    ...
                    <div className="card-body">
                      ...
                      <Link to={`/livroL/${book.id}`} className="btn btn-acervo-primary">Ver mais</Link>
                    </div>
                  </div>
                </div>
              ))}
